...
//     return setTimeout(() => {
//     return console.log(`Mars temparute is: ${getMarsTemperature()}`)
//     }, messageDelay()); 
// }
...
//   const Temperature5s = setTimeout(() => getMarsTemperature, messageDelay());

//   callback(Temperature5s);
// }
...
const sendMarsTemperature = (callback, callback2) => {
  const percentSucess = Math.random() <= 0.6;
  setTimeout(() => {
      if (percentSucess) callback(getMarsTemperature());
